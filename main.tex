...
La metodolog\'ia propuesta cuenta con tres procedimientos generales, donde las bandas infrarroja cercana y roja de las im\'agenes satelitales, en diferentes tiempos, constituyen entradas para la generaci\'on de un mapa que representa la perdida forestal (degradaci\'on y deforestaci\'on) con su correspondiente estimaci\'on de carbono, en toneladas por hect\'area, perdidos en el \'area evaluada.
\begin{itemize}
