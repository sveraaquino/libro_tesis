...
\nomenclature[47]{$ VT $}{Puntos de Verdad terreno.}
\nomenclature[48]{$ T $}{Puntos catalogados correctamente.}
\nomenclature[49]{$ F $}{Puntos catalogados correctamente.}
\nomenclature[50]{$ TP $}{Verdadero Positivo.}
\nomenclature[51]{$ FP $}{Falso Positivo.}
\nomenclature[52]{$ P $}{Total Positivo.}
\nomenclature[53]{$ N $}{Total Negativo.}
\nomenclature[54]{$ FN $}{Falso negativo.}
\nomenclature[55]{$ P^{'} $}{Total Positivo catalogado.}
\nomenclature[56]{$ N^{'} $}{Total Negativo catalogado.}
\begin{table}[H]
	\centering
\begin{tabular}{|
