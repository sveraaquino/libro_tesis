...
\nomenclature[31]{$ VT $}{Puntos de Verdad terreno.}
\nomenclature[31]{$ T $}{Puntos catalogados correctamente.}
\nomenclature[31]{$ F $}{Puntos catalogados correctamente.}
\nomenclature[31]{$ TP $}{Verdadero Positivo.}
\nomenclature[31]{$ FP $}{Falso Positivo.}
\nomenclature[31]{$ P $}{Total Positivo.}
\nomenclature[31]{$ N $}{Total Negativo.}
\nomenclature[31]{$ FN $}{Falso negativo.}
\nomenclature[31]{$ P^{,} $}{Total Positivo catalogado.}
\nomenclature[31]{$ N^{,} $}{Total Negativo catalogado.}
\begin{table}[H]
	\centering
\begin{tabular}{|
